...
[![Stars](https://img.shields.io/github/stars/TheLucifer-07/Relay?style=flat-square&color=18181B&labelColor=F4F4F5)](https://github.com/TheLucifer-07/Relay/stargazers)
[![React](https://img.shields.io/badge/React-19-18181B?style=flat-square&labelColor=F4F4F5)](#technology)
[![Vite](https://img.shields.io/badge/Vite-8-18181B?style=flat-square&labelColor=F4F4F5)](#technology)
[![Node](https://img.shields.io/badge/node-%3E%3D20-18181B?style=flat-square&labelColor=F4F4F5)](#getting-started)
[![PRs](https://img.shields.io/badge/PRs-welcome-18181B?style=flat-square&labelColor=F4F4F5)](#contributing)
...
```mermaid
flowchart LR
    A[Discover] --> B[Trade Details]
    B --> C[Negotiate]
    C --> D[Make an Offer]
    D --> E[Accept]
    E --> F[Schedule Handoff]
    F --> G[Exchange]
    G --> H[Leave a Review]
```
